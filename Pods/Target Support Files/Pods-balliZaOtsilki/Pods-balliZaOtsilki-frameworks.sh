...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Protobuf-iOS11.0/Protobuf.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QuickLayout-iOS11.0/QuickLayout.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SDWebImage-iOS11.0/SDWebImage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftEntryKit-iOS11.0/SwiftEntryKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftKeychainWrapper-iOS11.0/SwiftKeychainWrapper.framework"
