...
//  SuperDealProd
//
//  Created by iosdev on 02.03.2020.
...
extension UILabel {
    ...
    func addTrailing(with trailingText: String, moreText: String, moreTextFont: UIFont, moreTextColor: UIColor) {
        ...
        let readMoreAttributes = [NSAttributedString.Key.font: moreTextFont,
                                  NSAttributedString.Key.foregroundColor: moreTextColor]
        let readMoreAttributed = NSMutableAttributedString(string: moreText, attributes: readMoreAttributes)
